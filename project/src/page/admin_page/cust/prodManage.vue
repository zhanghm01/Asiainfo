<template>
  <div id='ordersearch-container'>
    <div class="content">
      ...
      <!-- 增改删时需要分别出现对应的遮罩层 -->
      <div class="operators" v-if='modifyope.isopen'>
        ...
        <div class="modifybox" v-if='modifyope.ismodify'>
          <!-- <div class="content">
            <div class="opes">
                <span>省:</span>
          ...
          <CustModify :modifyope = modifyope></CustModify>
        </div>
        <div class="deletebox" v-if='deleteope.isdelete'>
          ...
          <CustDelete :deleteope = deleteope></CustDelete>
        </div>
      </div>
    </div>
  </div>
...
import CustDelete from '../cust/CustDelete.vue'
import CustModify from '../cust/CustModify.vue'
export default {
    data() {
      return {
  ...
  methods: {
    ...
    handleEdit(index, row) {
        ...
        this.deleteope.modifyObj.PROVINCE = row.province;
        this.deleteope.modifyObj.CITY = row.city;
        this.deleteope.modifyObj.DISTRICT = row.district;
        this.deleteope.modifyObj.DC_NAME = row.dc_NAME;
        this.deleteope.modifyObj.DC_ADDRESS = row.dc_ADDRESS;
        this.deleteope.modifyObj.ADDR_ID_YLW = row.addr_ID_YLW;
        this.deleteope.modifyObj.DC_ADDR_ID = row.dc_ADDR_ID;
        this.deleteope.isopen = true;
        this.deleteope.ismodify = true;
